...
public class paypalfunctions  {
    ...
    gv_APIUserName	= "vkarthik1990-facilitator_api1.gmail.com";
    gv_APIPassword	= "T5L2UGKFV4BF6AZ9";
    gv_APISignature = "AFcWxV21C7fd0v3bYYYRCpSSRl31A9Es-cYJdrh7Nqo30Evq3FeghCy3";
...
/*********************************************************************************
  ...
  * Output: Returns a HashMap object containing the response from the server.
*********************************************************************************/
public HashMap CallMarkExpressCheckout( String paymentAmount, String returnURL, String cancelURL, String shipToName, String shipToStreet, String shipToStreet2, String shipToCity, String shipToState,
                                        String shipToCountryCode, String shipToZip, String phoneNum)
{
	/*
	'------------------------------------
	' The currencyCodeType and paymentType 
